class GUI (object):
    def __init__(self):
        ...
        self.totVol  = StringVar() #total voltage

        #AIU Logo
        self.logo = PhotoImage(file="Logo copy.gif")
        ...
        self.label21= Label(self.frame2,textvariable=self.variable,font=(14, 14,"bold"),foreground="green",background="light blue") #total voltage
    ...
    def grid(self):
        ...
        self.label21.pack(side=LEFT,fill=BOTH,expand=YES)
